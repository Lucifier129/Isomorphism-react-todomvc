...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoDispatcher = __webpack_require__(164);
	...
	var _componentView = __webpack_require__(175);
	...
	var App = (function () {
		...
		_createClass(App, [{
			...
			value: function init() {
				...
				this.model = new _model2['default'](this.getInitialData().todos);
			...
			value: function getInitialData() {
				var initialDataStore = document.getElementById('initialData');
				var initalData = initialDataStore.innerHTML;
			...
			value: function post(data) {
				_superagent2['default'].post(this.url).send(data).end();
			}
		}, {
			key: 'register',
			value: function register() {
				...
				_todoDispatcher2['default'].register(function (action) {
					var model = _this2.model;
					var todo = undefined;
					var hasTodo = undefined;
					switch (action.actionType) {
						...
						case 'updateTodo':
							...
							if (todo) {
								_superagent2['default'].patch(_this2.url).send({
									todo: todo
								}).end();
							}
							break;
						case 'removeTodo':
							...
							_superagent2['default'].del(_this2.url).send({
								id: action.id
							}).end();
							break;
						case 'clearCompleted':
			...
			value: function render(props) {
				...
				_reactDom2['default'].render(_react2['default'].createElement(_componentView2['default'], props), document.getElementById('todoapp'));
			}
		}, {
			key: 'listen',
			value: function listen() {
				...
				io().on('change', function (data) {
					_this3.model = new _model2['default'](data.todos);
					_this3.render();
				});
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMClient = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSPropertyOperations = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSProperty = __webpack_require__(29);
	var ExecutionEnvironment = __webpack_require__(30);

	var camelizeStyleName = __webpack_require__(31);
	var dangerousStyleValue = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(172);
	$def($def.S, 'Object', {assign: __webpack_require__(173)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(179)['default'];
	...
	var _newTodo = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$getOwnPropertyDescriptor = __webpack_require__(180)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todos = __webpack_require__(187);
			...
			value: function render() {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement('input', { id: 'toggle-all', type: 'checkbox', onChange: function (e) {
							return (0, _actions.toggleAll)(e.currentTarget.checked);
					...
					_react2['default'].createElement(_todos2['default'], { todos: this.props.todos })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectWithoutProperties = __webpack_require__(189)['default'];

	var _Object$keys = __webpack_require__(190)['default'];
	...
	var _springSpring = __webpack_require__(193);
	...
	var Todos = (function (_React$Component) {
		...
		_createClass(Todos, [{
			key: 'getValues',
			value: function getValues(update) {
				var configs = {};
			...
			key: 'willEnter',
			value: function willEnter(id) {
				console.log('enter');
				var todo = this.props.todos.filter(function (todo) {
			...
			key: 'willLeave',
			value: function willLeave(id, update, destVals, currVals) {
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					_springSpring.TransitionSpring,
					{ ref: 'transition', endValue: this.getValues.bind(this), willLeave: this.willLeave.bind(this), willEnter: this.willEnter.bind(this) },
					function (configs) {
						return _react2['default'].createElement(
							'ul',
							{ id: 'todo-list' },
							_Object$keys(configs).map(function (id, i, list) {
								var _configs$id = configs[id];
								var todo = _configs$id.todo;

								var style = _objectWithoutProperties(_configs$id, ['todo']);

								if (!style.opacity) {
									return null;
								}
								return _react2['default'].createElement(_todo2['default'], _extends({ key: todo.id, style: style }, todo));
							})
						);
					}
				);
	...
	var Todo = (function (_React$Component) {
		...
		_createClass(Todo, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					'li',
					{ key: this.props.key, className: this.getClassName(), title: this.props.time, style: this.props.style },
					_react2['default'].createElement(
						'div',
						{ className: 'view' },
						_react2['default'].createElement('input', { className: 'toggle', type: 'checkbox', onChange: function (e) {
								return _this.toggleTodo(e);
							}, checked: this.props.completed }),
						_react2['default'].createElement(
							'label',
							{ onDoubleClick: function (e) {
									return _this.handleDblclick(e);
								} },
							this.props.title
						),
...
/***/ function(module, exports, __webpack_require__) {
	...
	//from https://github.com/chenglou/react-animation
	'use strict';

	var _slicedToArray = __webpack_require__(194)['default'];

	var _toArray = __webpack_require__(213)['default'];

	var _toConsumableArray = __webpack_require__(220)['default'];
	...
	var _stepper7 = __webpack_require__(222);

	var _stepper8 = _interopRequireDefault(_stepper7);
	...
	if (typeof window !== 'undefined') {
	  window.addEventListener('keypress', function (_ref) {
	...
	function update(tree) {
	  var k = arguments[1] === undefined ? 170 : arguments[1];
	  var b = arguments[2] === undefined ? 26 : arguments[2];
	...
	function stripMarks(_x7) {
	  ...
	  _function: while (_again) {
	    ...
	    if (Object.prototype.toString.call(tree) === '[object Object]') {
	      var _ret = (function () {
	        var newTree = {};
	        _Object$keys(tree).forEach(function (key) {
	          return newTree[key] = stripMarks(tree[key]);
	        });
	        return {
	          v: newTree
	        };
	...
	function updateValsAndV(_x8, _x9, _x10, _x11) {
	  ...
	  _function2: while (_again2) {
	    var frameRate = _x8,
	        ...
	        currV = _x10,
	        destVals = _x11;
	    k = b = _ret2 = _ret3 = undefined;
	    var k = _arguments2[4] === undefined ? -1 : _arguments2[4];
	    _again2 = false;
	    var b = _arguments2[5] === undefined ? -1 : _arguments2[5];

	    if (destVals != null && destVals.__springK != null) {
	      _arguments2 = [_x8 = frameRate, _x9 = currVals, _x10 = currV, _x11 = destVals.value, destVals.__springK, destVals.__springB];
	      _again2 = true;
	      continue _function2;
	    }
	    if (Object.prototype.toString.call(destVals) === '[object Array]') {
	      var _ret2 = (function () {
	        var newCurrVals = new Array(destVals.length);
	        var newCurrV = new Array(destVals.length);
	        destVals.forEach(function (val, i) {
	          var _updateValsAndV = updateValsAndV(frameRate, currVals[i], currV[i], val, k, b);

	          var _updateValsAndV2 = _slicedToArray(_updateValsAndV, 2);

	          var nextCurVals = _updateValsAndV2[0];
	          var nextCurV = _updateValsAndV2[1];
	    ...
	    if (Object.prototype.toString.call(destVals) === '[object Object]') {
	      var _ret3 = (function () {
	        var newCurrVals = {};
	        var newCurrV = {};
	        _Object$keys(destVals).forEach(function (key) {
	          var _updateValsAndV3 = updateValsAndV(frameRate, currVals[key], currV[key], destVals[key], k, b);

	          var _updateValsAndV32 = _slicedToArray(_updateValsAndV3, 2);

	          var nextCurVals = _updateValsAndV32[0];
	          var nextCurV = _updateValsAndV32[1];
	    ...
	    return (0, _stepper8['default'])(frameRate, currVals, currV, destVals, k, b);
	  }
	}

	// assume a, b same shape
	// mutation, bc perf
	function prewalkAndMutatePosAndVTree(frameRate, pos, v, dest) {
	  var k = arguments[4] === undefined ? -1 : arguments[4];
	  var b = arguments[5] === undefined ? -1 : arguments[5];
	    ...
	    for (var i = 0; i < pos.length; i++) {
	      ...
	      if (typeof pos[i] === 'number') {
	        if (k === -1 || b === -1) {
	          ...
	          var _stepper = (0, _stepper8['default'])(frameRate, pos[i], v[i], dest[i], k, b);

	          var _stepper2 = _slicedToArray(_stepper, 2);

	          var newPos = _stepper2[0];
	    ...
	    for (var key in pos) {
	      if (typeof pos[key] === 'number') {
	        if (k === -1 || b === -1) {
	          ...
	          var _stepper3 = (0, _stepper8['default'])(frameRate, pos[key], v[key], dest[key], k, b);

	          var _stepper32 = _slicedToArray(_stepper3, 2);

	          var newPos = _stepper32[0];
	          var newV = _stepper32[1];
	...
	function mergeDiff(_x12, _x13, _x14, _x15) {
	  var _again3 = true;
	...
	function mergeDiffObj(a, b, onRemove) {
	  var keys = mergeDiff(_Object$keys(a), _Object$keys(b), function (a) {
	    return !onRemove(a);
	  }, []);
	  var ret = {};
	...
	function checkEndValues(endValue, component) {
	  ...
	  var owner = component._reactInternalInstance._currentElement._owner;
	  var ownerName = owner && owner.getName();
	  if (!warnedOwners[ownerName]) {
	    warnedOwners[ownerName] = true;
	    console.warn('You\'re passing a function to Spring prop `endValue` which doesn\'t receive `update` as the first argument. In this case, nothing will be animated. Were you trying to use the shorthand of directly passing a value (which calls `update` for you on the whole value under the hood)?. Check the render of `' + ownerName + '`.');
	  }
	}
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  propTypes: {
	    endValue: _react.PropTypes.oneOfType([_react.PropTypes.func, _react.PropTypes.object, _react.PropTypes.number]).isRequired
	  },
	  ...
	  getInitialState: function getInitialState() {
	    ...
	    var defaultVals = stripMarks(vals);
	    return {
	      currVals: defaultVals,
	      currV: (0, _utils.mapTree)(zero, defaultVals),
	      now: null
	    };
	  },
	  ...
	  raf: function raf() {
	    ...
	    this._rafID = requestAnimationFrame(function () {
	      ...
	      if (__DEV__) {
	        checkEndValues(endValue, _this);
	      }
	      // TODO: lol, refactor
	      var annotatedVals = undefined;
	      if (typeof endValue === 'function') {
	      ...
	      if (typeof currVals === 'number') {
	        var _stepper4 = (0, _stepper8['default'])(FRAME_RATE, currVals, currV, annotatedVals.value, annotatedVals.__springK, annotatedVals.__springB);

	        var _stepper42 = _slicedToArray(_stepper4, 2);

	        currVals = _stepper42[0];
	        currV = _stepper42[1];
	      } else {
	      ...
	      var _ret4 = (function () {
	        ...
	        return {
	          v: _react2['default'].createElement(
	            'div',
	            _this2.props,
	            (0, _utils.range)(hackOn).reduce(function (acc) {
	              ...
	              currV = (0, _utils.clone)(currV);
	              if (typeof currVals === 'number') {
	                var _stepper5 = (0, _stepper8['default'])(FRAME_RATE, currVals, currV, annotatedVals.value, annotatedVals.__springK, annotatedVals.__springB);

	                var _stepper52 = _slicedToArray(_stepper5, 2);

	                currVals = _stepper52[0];
	                currV = _stepper52[1];
	              } else {
	                prewalkAndMutatePosAndVTree(FRAME_RATE, currVals, currV, annotatedVals);
	              }

	              return [].concat(_toConsumableArray(acc), [[currVals, currV]]);
	            }, [[currVals, currV]]).map(function (_ref2) {
	              var _ref22 = _slicedToArray(_ref2, 1);

	              var currVals = _ref22[0];

	              return _react2['default'].createElement(
	                'span',
	                { style: { opacity: 0.2 } },
	                hackOn2 != null && _react2['default'].createElement(
	                  'div',
	                  { style: { position: 'absolute', left: 300, zIndex: 100, top: 0 } },
	                  _react2['default'].createElement('input', {
	                    type: 'range',
	                    min: 0,
	                ...
	                _this2.props.children(currVals)
	              );
	            })
	          )
	        };
	...
	var TransitionSpring = _react2['default'].createClass({
	  ...
	  propTypes: {
	    endValue: _react.PropTypes.oneOfType([_react.PropTypes.func,
	    // TODO: better warning
	    _react.PropTypes.object, _react.PropTypes.arrayOf(_react.PropTypes.shape({
	      key: _react.PropTypes.any.isRequired
	    })), _react.PropTypes.arrayOf(_react.PropTypes.element)]).isRequired,
	  ...
	  getDefaultProps: function getDefaultProps() {
	    return {
	      willEnter: function willEnter(key, currVals) {
	        return currVals[key];
	      },
	  ...
	  raf: function raf() {
	    ...
	    this._rafID = requestAnimationFrame(function () {
	      ...
	      var currVals = _state3.currVals;
	      var currV = _state3.currV;
	      var now = _state3.now;
	      ...
	      if (__DEV__) {
	        checkEndValues(endValue, _this3);
	      }
	      var annotatedVals = undefined;
	      if (typeof endValue === 'function') {
	        annotatedVals = endValue(update, currVals);
	      ...
	      var strippedVals = stripMarks(annotatedVals);
	      var shallowStrippedVals = annotatedVals.__springK == null ? annotatedVals : annotatedVals.value;

	      var shallowStrippedMergedVals = mergeDiffObj(currVals, shallowStrippedVals, function (key) {
	        return willLeave(key, update, strippedVals, currVals, currV);
	      });

	      var mergedVals = annotatedVals.__springK == null ? shallowStrippedMergedVals : update(shallowStrippedMergedVals, annotatedVals.__springK, annotatedVals.__springB);

	      currVals = (0, _utils.clone)(currVals);
	      currV = (0, _utils.clone)(currV);
	      _Object$keys(shallowStrippedMergedVals).filter(function (key) {
	      ...
	      var frameRate = now ? (Date.now() - now) / 1000 : FRAME_RATE;

	      if (typeof currVals === 'number') {
	        var _stepper6 = (0, _stepper8['default'])(FRAME_RATE, currVals, currV, annotatedVals.value, annotatedVals.__springK, annotatedVals.__springB);

	        var _stepper62 = _slicedToArray(_stepper6, 2);

	        currVals = _stepper62[0];
	        currV = _stepper62[1];
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator = __webpack_require__(195)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $           = __webpack_require__(5)
	  , Iterators   = __webpack_require__(201).Iterators
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $          = __webpack_require__(5)
	  , setUnscope = __webpack_require__(199)
	  , ITER       = __webpack_require__(200).safe('iter')
	  , $iter      = __webpack_require__(201)
	  , step       = $iter.step
	...
	__webpack_require__(206)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $                 = __webpack_require__(5)
	  ...
	  , Iterators         = __webpack_require__(204)('iterators')
	  , IteratorPrototype = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global = __webpack_require__(5).g
	  , store  = __webpack_require__(204)('wks');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Array$from = __webpack_require__(214)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S + $def.F * !__webpack_require__(219)(function(iter){ Array.from(iter); }), 'Array', {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SYMBOL_ITERATOR = __webpack_require__(203)('iterator')
	  , SAFE_CLOSING    = false;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _mapTree(path, f, trees) {
	  ...
	  if (Object.prototype.toString.call(t1) === '[object Object]') {
	    var _ret = (function () {
	      var newTree = {};
	      _Object$keys(t1).forEach(function (key) {
...
/***/ function(module, exports) {
	...
	function stepper(frameRate, x, v, destX, k, b) {
	  ...
	  var newX = x + v * (hackOn ? 1 / 1000 : frameRate);
	  var newV = v + a * (hackOn ? 1 / 1000 : frameRate);
