...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoDispatcher = __webpack_require__(2);
	...
	var _componentView = __webpack_require__(4);
	...
	var App = (function () {
		...
		_createClass(App, [{
				...
				_todoDispatcher2['default'].register(function (action) {
					...
					switch (action.actionType) {
						case 'addTodo':
							...
							break;
						case 'toggleAll':
							var hasTodo = model.toggleAll(action.completed);
							if (hasTodo !== false) {
								_this2.post({
									type: 'toggleAll',
						...
						case 'removeTodo':
							...
							break;
						case 'clearCompleted':
							var hasTodo = model.clearCompleted();
							if (hasTodo) {
								_this2.post({
									type: 'clearCompleted'
								});
			...
			value: function render(props) {
				...
				_react2['default'].render(_react2['default'].createElement(this.View, props), document.getElementById('todoapp'));
			}
		}, {
			key: 'listen',
	...
	new App(_componentView2['default'], _model2['default']).init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newTodo = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todo = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMIframe = __webpack_require__(85);
	...
	var ReactInstanceHandles = __webpack_require__(33);
	var ReactMount = __webpack_require__(34);
	var ReactReconcileTransaction = __webpack_require__(92);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _get = __webpack_require__(116)['default'];
	...
	var Todo = (function (_React$Component) {
		...
		_createClass(Todo, [{
			...
			value: function render() {
				...
				return _react2['default'].createElement(
					'li',
					{ className: this.getClassName(), title: this.props.time },
					_react2['default'].createElement(
						'div',
						{ className: 'view' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(117).core.Object.assign;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = module.exports = __webpack_require__(163)({
	  g: global,
	  core: core,
...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.S, 'Object', {assign: __webpack_require__(165)});
